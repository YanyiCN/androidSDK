...
@ccclass
export default class WelfareGemLayer extends MyNode {
    ...
    private initView() {
        ...
        for (let i = 0; i < length; i++) {
            ...
            node.getChildByName("lbWelfareDes").getComponent(cc.Label).string = ComUtil.formatStr("完成%s获得丰富金币奖励", nameArr[i]);
